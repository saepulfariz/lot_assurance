                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" required name="ply_code" id="ply_code" class="form-control" value="<?= $lot['ply_code']; ?>">
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="time" required name="time_start" id="time_start" class="form-control" value="<?= date('H:i:s', strtotime($lot['time_start'])); ?>">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="no_recipe_size_spec" id="no_recipe_size_spec" class="form-control" value="<?= $lot['no_recipe_size_spec']; ?>">
                                    </div>

                                    <div class="col-md-4">
                                        <label for="no_recipe_size_act">no_recipe_size_act</label>
                                        <input type="text" name="no_recipe_size_act" id="no_recipe_size_act" class="form-control" value="<?= $lot['no_recipe_size_act']; ?>">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="material_code_spec" id="material_code_spec" class="form-control" value="<?= $lot['material_code_spec']; ?>">
                                        </div>

                                        <div class="col-md-4">
                                            <label for="material_code_act">material_code_act</label>
                                            <input type="text" name="material_code_act" id="material_code_act" class="form-control" value="<?= $lot['material_code_act']; ?>">
                                        </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="marking_colour_spec" id="marking_colour_spec" class="form-control" value="<?= $lot['marking_colour_spec']; ?>">
                                        </div>

                                        <div class="col-md-4">
                                            <label for="marking_colour_act">marking_colour_act</label>
                                            <input type="text" name="marking_colour_act" id="marking_colour_act" class="form-control" value="<?= $lot['marking_colour_act']; ?>">
                                        </div>
                                ...
                                <div class="col-md-2 mb-2">
                                    ...
                                    <input type="date" required name="expired_date" id="expired_date" class="form-control" value="<?= $lot['expired_date']; ?>">
                                </div>

                                <div class="col-md-2 mb-2">
                                    <label for="approval_lab">approval_lab</label>
                                    <input type="text" required name="approval_lab" id="approval_lab" class="form-control" value="<?= $lot['approval_lab']; ?>">
                                </div>

                                <div class="col-md-2 mb-2">
                                    <label for="lot_number">lot_number</label>
                                    <input type="text" required name="lot_number" id="lot_number" class="form-control" value="<?= $lot['lot_number']; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" name="width_5_spec" id="width_5_spec" class="form-control" value="<?= $lot['width_5_spec']; ?>">
                                        </div>

                                        <div class="col-md-2">
                                            <label for="width_5_act1">width_5_act1</label>
                                            <input type="text" name="width_5_act1" id="width_5_act1" class="form-control" value="<?= $lot['width_5_act1']; ?>">
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" name="width_5_act2" id="width_5_act2" class="form-control" value="<?= $lot['width_5_act2']; ?>">
                                        </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" name="width_5_act3" id="width_5_act3" class="form-control" value="<?= $lot['width_5_act3']; ?>">
                                        </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="angle_1_spec" id="angle_1_spec" class="form-control" value="<?= $lot['angle_1_spec']; ?>">
                                        </div>

                                        <div class="col-md-4">
                                            <label for="angle_1_act">angle_1_act</label>
                                            <input type="text" name="angle_1_act" id="angle_1_act" class="form-control" value="<?= $lot['angle_1_act']; ?>">
                                        </div>
                                ...
                                <div class="col-md-5 mb-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="stager_02_act" id="stager_02_act" class="form-control" value="<?= $lot['stager_02_act']; ?>">
                                        </div>
                                ...
                                <div class="col-md-5 mb-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="overlap_joint_41_act" id="overlap_joint_41_act" class="form-control" value="<?= $lot['overlap_joint_41_act']; ?>">
                                        </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-md-2">
                                ...
                                <input type="text" required name="qty_roll" id="qty_roll" class="form-control" value="<?= $lot['qty_roll']; ?>">
                            </div>

                            <div class="col-md-2">
                                <label for="qty_metter">qty_metter</label>
                                <input type="text" required name="qty_metter" id="qty_metter" class="form-control" value="<?= $lot['qty_metter']; ?>">
                            </div>

                            <div class="col-md-2">
                                <label for="qty_lot_sc">qty_lot_sc</label>
                                <input type="text" required name="qty_lot_sc" id="qty_lot_sc" class="form-control" value="<?= $lot['qty_lot_sc']; ?>">
                            </div>

                            <div class="col-md-2">
                                <label for="qty_lot_f">qty_lot_f</label>
                                <input type="text" required name="qty_lot_f" id="qty_lot_f" class="form-control" value="<?= $lot['qty_lot_f']; ?>">
                            </div>


                            <div class="col-md-2">
                                <label for="problem_loss_time">problem_loss_time</label>
                                <input type="text" name="problem_loss_time" id="problem_loss_time" class="form-control" value="<?= $lot['problem_loss_time']; ?>">
                            </div>
