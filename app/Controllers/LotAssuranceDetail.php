...
class LotAssuranceDetail extends BaseController
{
    ...
    public function show($id = null)
    {
        ...
        return view('lot_list/show', $data);
    }
    ...
    public function edit($id = null)
    {
        ...
        return view('lot_list/edit', $data);
    }
    ...
    public function update($id = null)
    {
        ...
        $this->modellotdetail->update($id, $data);
        $id = $this->modellotdetail->find($id)['id_lot'];
        $this->alert->set('success', 'Success', 'Success Update');
        return redirect()->to('lot/' . $id);
    }
